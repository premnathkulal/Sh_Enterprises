...
public class Home_page extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nav_user = (TextView)hView.findViewById(R.id.sup_name);
        TextView nav_email = (TextView)hView.findViewById(R.id.email);

        nav_user.setText(Login.pcg.readName());
        nav_email.setText(Login.pcg.readEmail());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_product) {
            ...
            Login.pcg.wrightLogin(false);
            Login.pcg.writeName("user");
